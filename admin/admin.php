...
<head>
    ...
    <style>
        ...
        .sidebar { width: 260px; min-height: 100vh; background: #ffffff; }
                            ...
                            document.querySelectorAll('#logs tbody tr').forEach(row => {
                                ...
                                row.onclick = function(e) {
                                    if (!e.target.closest('.print-session')) {
                                        ...
                                        window.location.href = `admin_viewer.php?${params.toString()}`;
                                    }
                                };
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    archiveBtn.addEventListener('click', async function () {
        ...
        try {
            const response = await fetch('archive_logs.php', { method: 'POST' });
